...
?>
    <div class="br-mainpanel">
        ...
        <div class="row">
            <div class="col-md-6">
                <form id="form-upgrade" class="card shadow-base bd-0" action="<?=HTTP.'?merchant=ovo_request&act=step2';?>" method="post">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mg-b-0">
                                    <label class="form-control-label">Input OTP Code: <span class="tx-danger">*</span></label>
                                    <input type="text" name="txtOTPCode" class="form-control" placeholder="1234" required autofocus>
                                    <ul class="fields-message"></ul>
                                </div>
                                <input type="hidden" name="txtOVOPhoneNumber" value="<?=$_GET['phoneNumber'];?>" required>
                                <input type="hidden" name="txtOVORefId" value="<?=$_GET['refId'];?>" required>
                            </div>
                        </div>
                    </div>
