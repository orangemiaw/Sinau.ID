...
<body>
	<div class="single-layout d-flex align-items-center justify-content-center bg-br-primary ht-100v">
		...
		<form action="<?=HTTP."?do=register";?>" id="register" class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base" method="post" accept-charset="utf-8">
        ...
        <div class="form-group">
                <input class="form-control" type="text" name="name" value="" autocomplete="off" placeholder="Nama Lengkap">
                <ul class="field-message parsley-errors-list filled">
                                    </ul>
            </div>

			<div class="form-group">
				<input class="form-control" type="text" name="login" value="" autocomplete="off" placeholder="Username">
				<ul class="field-message parsley-errors-list filled">
									</ul>
			</div>
			...
			<div class="form-group">
				<input class="form-control" type="password" name="passwd" value="" placeholder="Password" autocomplete="">
				<ul class="field-message parsley-errors-list filled">
									</ul>
			</div>

            <div class="form-group">
                <input class="form-control" type="password" name="confirm_passwd" value="" placeholder="Konfirmasi Password" autocomplete="">
                <ul class="field-message parsley-errors-list filled">
                                    </ul>
            </div>
			...
			<div class="form-group">
				...
				<?php endif;?>
				<a href="#" class="tx-success tx-12 d-block mg-t-10">Lupa password?</a>
			</div>


            <button class="btn btn-primary btn-block" type="submit">Register <i class="ion ion-md-log-in"></i></button>

            <div class="mg-t-20 tx-center">Sudah punya akun? <a href="<?=HTTP.'?page=login';?>" class="tx-success">Login</a></div>
