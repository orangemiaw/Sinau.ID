			...
			<div class="row">
                        <div class="col-md-12 tx-center">
                            <div class="form-group">
                                ...
                                <img src="<?=$arr_question['profile_image'] ? HTTP . $arr_question['question_image'] : HTTP . UNAVAILABLE_IMAGE;?>" width="300" />
                            </div>
                        </div>
                        <div class="col-md-12">
							<div class="form-group mg-b-0">
								<label class="form-control-label">Question Text: <span class="tx-danger">*</span></label>
								<input type="text" name="txtQuestion" class="form-control" value="<?=$arr_question['question_text'];?>" required autofocus>
