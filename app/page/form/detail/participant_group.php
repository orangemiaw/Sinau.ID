...
$title = "Detail Participant Group";
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" name="txtGroupName" value="<?=$arr_participant_group['participant_group_name'];?>" class="form-control" disabled="disabled">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="txtPrice" value="<?=convert_to_rupiah($arr_participant_group['participant_group_price'] * RATE_USD_TO_IDR);?>" class="form-control" disabled="disabled">
						<ul class="fields-message"></ul>
					</div>
				</div>
